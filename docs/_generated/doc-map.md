...
| 章 | 教材 | 公式ページ |
|---|---|---|
| 10級 | [kyu/10-what-is-jev.md](../kyu/10-what-is-jev.md) | [/introduction](https://docs.typesafe.ai/introduction)<br>[/concepts/system-one](https://docs.typesafe.ai/concepts/system-one) |
| 9級 | [kyu/09-setup.md](../kyu/09-setup.md) | [/introduction/quickstart](https://docs.typesafe.ai/introduction/quickstart)<br>[/sdk/javascript](https://docs.typesafe.ai/sdk/javascript) |
| 8級 | [kyu/08-first-call.md](../kyu/08-first-call.md) | [/introduction/quickstart](https://docs.typesafe.ai/introduction/quickstart)<br>[/api](https://docs.typesafe.ai/api) |
| 7級 | [kyu/07-noul.md](../kyu/07-noul.md) | [/primitives](https://docs.typesafe.ai/primitives)<br>[/primitives/noul](https://docs.typesafe.ai/primitives/noul) |
| 6級 | [kyu/06-choice.md](../kyu/06-choice.md) | [/primitives](https://docs.typesafe.ai/primitives)<br>[/primitives/choice](https://docs.typesafe.ai/primitives/choice) |
| 5級 | [kyu/05-score.md](../kyu/05-score.md) | [/primitives](https://docs.typesafe.ai/primitives)<br>[/primitives/score](https://docs.typesafe.ai/primitives/score) |
| 4級 | [kyu/04-batch.md](../kyu/04-batch.md) | [/patterns/fan-out](https://docs.typesafe.ai/patterns/fan-out)<br>[/cookbooks/parallel_questions](https://docs.typesafe.ai/cookbooks/parallel_questions) |
| 初段 | [dan/01-state.md](../dan/01-state.md) | [/concepts/state](https://docs.typesafe.ai/concepts/state) |
| 二段 | [dan/02-instructions.md](../dan/02-instructions.md) | [/primitives/advanced](https://docs.typesafe.ai/primitives/advanced) |
| 三段 | [dan/03-confidence.md](../dan/03-confidence.md) | [/confidence](https://docs.typesafe.ai/confidence)<br>[/patterns/confidence-routing](https://docs.typesafe.ai/patterns/confidence-routing) |
| 四段 | [dan/04-patterns.md](../dan/04-patterns.md) | [/patterns](https://docs.typesafe.ai/patterns)<br>[/patterns/composite-scoring](https://docs.typesafe.ai/patterns/composite-scoring)<br>[/patterns/intent-routing](https://docs.typesafe.ai/patterns/intent-routing) |
| 五段 | [dan/05-boundary.md](../dan/05-boundary.md) | [/concepts/how-to-build-with-system-one](https://docs.typesafe.ai/concepts/how-to-build-with-system-one) |
| 六段 | [kodan/06-dataset.md](../kodan/06-dataset.md) | [/introduction/machine-learning-primer](https://docs.typesafe.ai/introduction/machine-learning-primer) |
| 七段 | [kodan/07-calibration.md](../kodan/07-calibration.md) | [/introduction/machine-learning-primer](https://docs.typesafe.ai/introduction/machine-learning-primer)<br>[/cookbooks/classification_using_confidence](https://docs.typesafe.ai/cookbooks/classification_using_confidence) |
| 八段 | [kodan/08-japanese-lab.md](../kodan/08-japanese-lab.md) | [/models](https://docs.typesafe.ai/models)<br>[/model-jaggedness/jev-1.13](https://docs.typesafe.ai/model-jaggedness/jev-1.13) |
| 九段 | [kodan/09-production.md](../kodan/09-production.md) | [/models](https://docs.typesafe.ai/models)<br>[/api](https://docs.typesafe.ai/api)<br>[/sdk/javascript](https://docs.typesafe.ai/sdk/javascript) |
| 十段 | [kodan/10-limits.md](../kodan/10-limits.md) | [/model-jaggedness/jev-1.13](https://docs.typesafe.ai/model-jaggedness/jev-1.13)<br>[/legal](https://docs.typesafe.ai/legal) |
| 奥義 | [kaiden/01-mechanism.md](../kaiden/01-mechanism.md) | [/concepts/system-one](https://docs.typesafe.ai/concepts/system-one)<br>[/confidence](https://docs.typesafe.ai/confidence)<br>[/models](https://docs.typesafe.ai/models) |
| 皆伝 | [kaiden/02-exam.md](../kaiden/02-exam.md) | [/concepts/how-to-build-with-system-one](https://docs.typesafe.ai/concepts/how-to-build-with-system-one) |
| 応用A | [advanced/a-tanstack-cloudflare.md](../advanced/a-tanstack-cloudflare.md) | [/sdk/javascript](https://docs.typesafe.ai/sdk/javascript) |
| 応用B | [advanced/b-two-layer.md](../advanced/b-two-layer.md) | [/concepts/how-to-build-with-system-one](https://docs.typesafe.ai/concepts/how-to-build-with-system-one)<br>[/cookbooks/citation_check](https://docs.typesafe.ai/cookbooks/citation_check) |
| 応用C | [advanced/c-frameworks.md](../advanced/c-frameworks.md) | [/sdk/javascript](https://docs.typesafe.ai/sdk/javascript)<br>[/api](https://docs.typesafe.ai/api) |
| 応用D | [advanced/d-agent-skill.md](../advanced/d-agent-skill.md) | [/agent-skill](https://docs.typesafe.ai/agent-skill) |
