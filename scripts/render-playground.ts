...
- サンプルの中には、state を文字列のまま送っているものがあります。Playground の State の欄は JSON のオブジェクトなので、このページでは \`{ "post": "…" }\` の形に包んでいます。著者が第 5 章・第 6 章・第 9 章で試したところ、包んだ形でも、モデルが \`jev-latest\` のままでも、確率は本の数字との差が 0.01 以内でした
